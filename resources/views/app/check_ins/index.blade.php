<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            @lang('crud.check_in.index_title')
        </h2>
    </x-slot>
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                >
                                    ...
                                    >
                                        @can('update', $checkIn)
                                        <a
                                            href="{{ route('check-ins.edit', $checkIn) }}"
                                            class="mr-1"
                                        >
                                            <button
                                                type="button"
                                        ...
                                        @endcan @can('view', $checkIn)
                                        <a
                                            href="{{ route('check-ins.show', $checkIn) }}"
                                            class="mr-1"
                                        >
                                            <button
                                                type="button"
                                        ...
                                        @endcan @can('delete', $checkIn)
                                        <form
                                            action="{{ route('check-ins.destroy', $checkIn) }}"
                                            method="POST"
